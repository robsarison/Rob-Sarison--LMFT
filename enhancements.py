...
'/contact/':('Schedule a Therapy Consultation | Rob Sarison, LMFT','Request a consultation with Rob Sarison through SimplePractice. Ask about individual, couples or family therapy, caregiving support and California telehealth.'),
'/client-portal/':('Secure SimplePractice Client Portal | Rob Sarison','Established clients can sign in to Rob Sarison’s secure SimplePractice portal. Appointment details and practice services stay separate from this information site.'),
'/privacy/':('Website Privacy & Practice Information | Rob Sarison','Read how Rob Sarison’s website handles hosting data, SimplePractice links and optional YouTube videos. No clinical forms, advertising trackers or analytics.'),
'/404.html':('Page Not Found | Rob Sarison Psychotherapy','Find your way back to Rob Sarison’s psychotherapy website, explore services, or request a consultation through the secure practice portal.')}
